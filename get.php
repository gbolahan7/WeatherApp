...
$city = $_GET['q'];
 $string = "http://api.openweathermap.org/data/2.5/weather?q=".$city."&units=metric&appid=ff7f7875567543226e16ed7e91dcd915";
 ...
 $time =  "<b>Time:".$currentTime. "</b><br>";
//  $timezone = "<b>Time:".date('h:i P', $data['sys']['timezone'])."</b>"; 
...
?>
	...
	<div class="w3-display-container w3-wide">
		<img src="weather5.jpg" style="width:100%;height:100%;" class="w3-image">
...
<h1 class="w3-xlarge">
  ...
  <!-- Copyright -->
  <div class="footer-copyright text-center py-3">© 2018 Copyright: Abass Durodola
